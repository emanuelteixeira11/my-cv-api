...
import { AcademicExperienceComponent } from 'app/entities/academic-experience/academic-experience.component';
...
describe('Component Tests', () => {
  describe('AcademicExperience Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.academicExperiences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
