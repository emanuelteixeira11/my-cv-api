...
import com.api.cv.repository.ProjectRepository;
...
public class ProjectResourceIT {
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getLongDescription()).isEqualTo(DEFAULT_LONG_DESCRIPTION);
    ...
    public void updateProject() throws Exception {
        ...
        assertThat(testProject.getLongDescription()).isEqualTo(UPDATED_LONG_DESCRIPTION);
