...
import com.api.cv.config.audit.AuditEventConverter;
import com.api.cv.domain.PersistentAuditEvent;
...
import static com.api.cv.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
